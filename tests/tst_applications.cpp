...
void TestApplications::get() {
    ...
    application->setLinuxPath("/my/application/path");
...
void TestApplications::add() {
    ...
    application1->setLinuxPath("/my/application/path1");
    applications->add(application1);

    Application* application2 = new Application();
    application2->setLinuxPath("/my/application/path2");
    applications->add(application2);

    Application* application3 = new Application();
    application3->setLinuxPath("/my/application/path3");
    applications->add(application3);

    Application* application4 = new Application();
    application4->setLinuxPath("/my/application/path2");
